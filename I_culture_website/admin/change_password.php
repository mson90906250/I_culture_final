...
<style>
	body{
		background-image:url("/I_culture_website/images/background/background.jpg");
...
<div id="login-form">
	<div>
		...
		if($_POST){
			...
			if(!empty($errors)){
				...
				//若無錯誤產生即執行登入
				$hashed_password = password_hash($password,PASSWORD_DEFAULT);
				$db->query("UPDATE admin SET password = '$hashed_password' WHERE id = '$user_id'");
	...
	<p class="text-right"><a href="/I_culture_website/index.php" alt="Home">Visit Site</a></p>
</div>
